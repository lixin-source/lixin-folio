  ...
  return (
    ...
    <section id="about">
      <div className='aboutSection'>
        ...
        <img src='./imgs/aboutimg.png' className='aboutimg'/>
      </div>
    </section>
    ...
    <section id="experiences">
      <div className='expSection'>
        ...
        <div className='timeline'>
          ...
          ' img='./imgs/awc.jpg' date='June 2023 - present' location='Remote'/>
          ...
          img='./imgs/cp.jpg' date='July 2023 - present' location='Remote'/>
          ...
          ' img='./imgs/dreamus.jpg' date ='Mar 2023 - Jun 2023' location='Remote'/>
          ...
          ' img='./imgs/nydoe.jpg' date ='Nov 2021 - Jun 2023' location='Hybrid'/>
          ...
          ' img='./imgs/bccc.PNG' date ='Oct 2022 - May 2023' location='Brooklyn, NY'/>
          ...
          ' img='./imgs/pfizer.jpg' date ='Jun 2021 - Apr 2022' location='New York City, NY'/>
          ...
          ' img='./imgs/ccb4a.PNG' date ='May 2022 - Sep 2022' location='Remote'/>

          <ListItem title='Researcher @ Brooklyn College Sociology Department' content='
          Collaborated in a team of 3 to create a machine learning model with Python, NumPy, Scikit-Learn, & Pandas that analyzed department turnover.
          Organized weekly team meetings to discuss project scope, delegate tasks, and company pain points.
          Communicated data analysis & results to stakeholders
          ' img='./imgs/bc.jpg' date ='Sep 2022 - May 2023' location='Brooklyn, NY'/>
          ...
          ' img='./imgs/ifem.jpg' date ='Aug 2021 - Mar 2022' location='Remote'/>
          ...
          ' img='./imgs/ms.jpg' date ='June 2021' location='Remote'/>
...
{/* GET IMGS FOR: */}
          ...
          ' img='./imgs/nysylc.jpg' date ='Nov 2020 - Sep 2021' location='Remote'/>
          ...
          ' img='./imgs/btt.jpg' date ='Nov 2020 - Sep 2021' location='Remote'/>
          ...
          ' img='./imgs/dsc.jpg' date ='Aujg 2020 - June 2021' location='Remote'/>
          ...
          ' img='./imgs/ifem.jpg' date ='Apr 2020 - Mar 2021' location='Remote'/>
          ...
          ' img='./imgs/uwnyc.jpg' date ='Jan 2020' location='New York City, NY'/>
    ...
    <section id='projects'>
      ...
      <div className='projectsSection'>
        ...
        recipes. I designed and created it by myself to help people share their recipes with each other.' img='./imgs/proj1.PNG'
        ...
        img='./imgs/proj2.PNG' techstack='Figma' demo='https://www.figma.com/proto/qrRI6cuDM4SQmPXWXwyfLb/Avocademy-team-library?node-id=411%3A21&scaling=scale-down&page-id=411%3A18&starting-point-node-id=411%3A21&show-proto-sidebar=1' />
        ...
        img='./imgs/proj3.PNG' techstack='React, Javascript, HTML/CSS' github='https://github.com/lixin-source/sanrio-quiz' demo='https://nimble-marzipan-e3d3b4.netlify.app/'/>
      </div>
    </section>
    ...
    <section id='media'>
      ...
      <div className='mediaCards'>
        ...
        img='./imgs/media/media1.jpeg' title='Panelist' date='Apr 2023' event='Guttman Community College' descrip='A panel discussion about career pathways for immigrant students'/>

        <MediaCard link='https://www.linkedin.com/posts/activity-7057743198399393792-YTgy/?utm_source=share&utm_medium=member_desktop'
        img='./imgs/media/media2.PNG' title='Panelist' date='Apr 2023' event='CUNY IIE Conference' descrip='As a part of the conference, the panel discussed career opportunities and challenges for immigrant educators within higher education.'/>
      
      <MediaCard link='https://www.linkedin.com/posts/activity-7057743198399393792-YTgy/?utm_source=share&utm_medium=member_desktop'
        img='./imgs/media/media3.jpg' title='Panelist' date='Feb 2023' event='TheDream.US Scholar Welcome' descrip='A speaker panel about the experiences of TheDream.US scholars, helping students answer questions'/>
    ...
    <section id='contact'>
      <div className='contactSection'>
        ...
        <a href='mailto:xinyi.li88@bcmail.cuny.edu' target='_blank' rel='noopener noreferrer'>
            <button><img src='./assets/light/mail.svg' alt='Email' /></button>
          </a>
          <a href='https://github.com/lixin-source' target='_blank' rel='noopener noreferrer'>
            <button><img src='./assets/light/github.svg' alt='GitHub' /></button>
          </a>
          <a href='https://www.linkedin.com/in/x-li/' target='_blank' rel='noopener noreferrer'>
            <button><img src=' ./assets/light/linkedin.svg' alt='LinkedIn' /></button>
          </a>
        </div>
        </div>
    </section>
